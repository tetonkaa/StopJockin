...
const UploadGallery_1 = __importDefault(require("../../../elements/UploadGallery"));
...
const DefaultList = (props) => {
    var _a, _b;
    const { collection, collection: { upload, slug, labels: { singular: singularLabel, plural: pluralLabel, }, admin: { description, } = {}, }, data, newDocumentURL, limit, tableColumns, columnNames, setColumns, hasCreatePermission, disableEyebrow, modifySearchParams, disableCardLink, onCardClick, handleSortChange, handleWhereChange, handlePageChange, handlePerPageChange, customHeader, } = props;
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        ...
        react_1.default.createElement(Gutter_1.Gutter, { className: `${baseClass}__wrap` },
            ...
            react_1.default.createElement(ListControls_1.default, { collection: collection, columns: columnNames, setColumns: setColumns, enableColumns: Boolean(!upload), enableSort: Boolean(upload), modifySearchQuery: modifySearchParams, handleSortChange: handleSortChange, handleWhereChange: handleWhereChange }),
            (data.docs && data.docs.length > 0) && (react_1.default.createElement(react_1.default.Fragment, null,
                !upload && (react_1.default.createElement(RelationshipProvider_1.RelationshipProvider, null,
                    react_1.default.createElement(Table_1.default, { data: data.docs, columns: tableColumns }))),
                upload && (react_1.default.createElement(UploadGallery_1.default, { docs: data.docs, collection: collection, onCardClick: (doc) => {
                        if (typeof onCardClick === 'function')
                            onCardClick(doc);
                        if (!disableCardLink)
                            history.push(`${admin}/collections/${slug}/${doc.id}`);
                    } })))),
            ...
            react_1.default.createElement("div", { className: `${baseClass}__page-controls` },
                ...
                (data === null || data === void 0 ? void 0 : data.totalDocs) > 0 && (react_1.default.createElement(react_1.Fragment, null,
                    react_1.default.createElement("div", { className: `${baseClass}__page-info` },
                        ...
                        ' ',
                        data.totalDocs),
                    react_1.default.createElement(PerPage_1.default, { limits: (_b = (_a = collection === null || collection === void 0 ? void 0 : collection.admin) === null || _a === void 0 ? void 0 : _a.pagination) === null || _b === void 0 ? void 0 : _b.limits, limit: limit, modifySearchParams: modifySearchParams, handleChange: handlePerPageChange })))))));
};
