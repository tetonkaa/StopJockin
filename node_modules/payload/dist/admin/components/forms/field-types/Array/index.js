...
const ArrayFieldType = (props) => {
    var _a, _b;
    const { name, path: pathFromProps, fields, fieldTypes, validate = validations_1.array, required, maxRows, minRows, permissions, indexPath, admin: { readOnly, description, condition, initCollapsed, className, components, }, } = props;
    ...
    return (react_1.default.createElement(react_beautiful_dnd_1.DragDropContext, { onDragEnd: onDragEnd },
        react_1.default.createElement("div", { id: `field-${path.replace(/\./gi, '__')}`, className: classes },
            ...
            react_1.default.createElement(react_beautiful_dnd_1.Droppable, { droppableId: "array-drop" }, (provided) => (react_1.default.createElement("div", { ref: provided.innerRef, ...provided.droppableProps },
