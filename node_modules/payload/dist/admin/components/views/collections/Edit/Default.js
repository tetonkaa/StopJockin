...
const DefaultEditView = (props) => {
    ...
    const { collection, isEditing, data, onSave, permissions, isLoading, initialState, apiURL, action, hasSavePermission, disableEyebrow, disableActions, disableLeaveWithoutSaving, customHeader, id, updatedAt, } = props;
    ...
    return (react_1.default.createElement("div", { className: classes },
        ...
        !isLoading && (react_1.default.createElement(OperationProvider_1.OperationContext.Provider, { value: operation },
            react_1.default.createElement(Form_1.default, { className: `${baseClass}__form`, method: id ? 'patch' : 'post', action: action, onSuccess: onSave, disabled: !hasSavePermission, initialState: initialState },
                !disableEyebrow && (react_1.default.createElement(SetStepNav_1.SetStepNav, { collection: collection, isEditing: isEditing, id: data.id })),
                    ...
                    react_1.default.createElement(Gutter_1.Gutter, { className: `${baseClass}__edit` },
                        react_1.default.createElement("header", { className: `${baseClass}__header` },
                            ...
                            !customHeader && (react_1.default.createElement("h1", null,
                                react_1.default.createElement(RenderTitle_1.default, { data: data, collection: collection.slug, useAsTitle: useAsTitle, fallback: `[${t('untitled')}]` })))),
                        ...
                        upload && (react_1.default.createElement(Upload_1.default, { data: data, collection: collection })),
                            ...
                            isEditing && (react_1.default.createElement("ul", { className: `${baseClass}__meta` },
                                ...
                                timestamps && (react_1.default.createElement(react_1.default.Fragment, null,
                                    updatedAt && (react_1.default.createElement("li", null,
                                        ...
                                        react_1.default.createElement("div", null, (0, format_1.default)(new Date(updatedAt), dateFormat)))),
                                    ((publishedDoc === null || publishedDoc === void 0 ? void 0 : publishedDoc.createdAt) || (data === null || data === void 0 ? void 0 : data.createdAt)) && (react_1.default.createElement("li", null,
                                        ...
                                        react_1.default.createElement("div", null, (0, format_1.default)(new Date((publishedDoc === null || publishedDoc === void 0 ? void 0 : publishedDoc.createdAt) || (data === null || data === void 0 ? void 0 : data.createdAt)), dateFormat))))))))))))))));
};
